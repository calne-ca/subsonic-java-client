...
public class AirsonicContainer extends SubsonicBaseContainer {
    public AirsonicContainer() {
        super("ghcr.io/linuxserver/airsonic");

        withExposedPorts(4040);
        withEnv("PUID","1000");
        withEnv("PGID","1000");
        withEnv("TZ","Europe/Berlin");
        withEnv("CONTEXT_PATH",contextPath());
